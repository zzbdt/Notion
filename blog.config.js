...
const BLOG = {
  AUTHOR: '正阳本地通', // 作者
  BIO: '一个普通的正阳人🍚', // 作者简介
  LINK: 'https://zzbdt.top', // 网站地址
  KEYWORDS: '正阳, 信息,本地通', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '8aaa958782774c0cbc0117f29fb0f86e', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
